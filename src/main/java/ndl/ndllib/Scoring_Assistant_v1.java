...
//                System.out.println("Height: " + height + " width: " + width + " FPS: " + fps + "total frame count: " + getTotalFrames());
        ...
        private synchronized boolean initMainStack(int mainChunkSize) {
            ...
            {
                javax.swing.JOptionPane.showMessageDialog(null,"Failed to open the video");
                return(false);
            }
            if (read != true){
                javax.swing.JOptionPane.showMessageDialog(null,"The video frame could not be read");
                return(false);
            }
            this.incPosFrame();
